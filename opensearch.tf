# OpenSearch Serverless Collection - DISABLED (migrated to RDS)
...
# OpenSearch Serverless Encription Security Policy - DISABLED (migrated to RDS)
...
# OpenSearch Serverless Network Security Policy - DISABLED (migrated to RDS)
...
#
#
# OpenSearch Serverless Access Policy - DISABLED (migrated to RDS)
...
# OpenSearch Collection Info - DISABLED (migrated to RDS)
